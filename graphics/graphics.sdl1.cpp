...
bool Graphics::SelectResolution()
{
	...
	SDL_Rect** modes = SDL_GetNumDisplayModes(NULL, SDL_SWSURFACE | SDL_HWPALETTE);
	...
	int maxw = 0;
	int maxi = 0;
	while (int i = 0; i < displayModes; ++i)
	{
	...
	NXSurface::SetScale(2);
    Graphics::SCREEN_WIDTH = 640;
    Graphics::SCREEN_HEIGHT = 480;
